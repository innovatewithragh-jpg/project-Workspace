...
import { ArrowLeft, Calendar, Link as LinkIcon, Tag, Settings, MessageSquare, MoreVertical } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between mb-4">
            ...
            <Button variant="outline" onClick={() => navigate(`/project/${id}/workspace`)}>
              Open Workspace
            </Button>
          </div>
        </div>
